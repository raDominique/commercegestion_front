...
function Table({ className, ...props }) {
  return (
    ...
    >
      <table
        data-slot="table"
        className={cn("w-full caption-bottom text-s bg-white table-auto", className)}
        {...props}
      />
    </div>
  );
...
function TableFooter({ className, ...props }) {
  return (
    <tfoot
      ...
      className={cn(
        "bg-muted/50 border-t font-medium [&>tr]:last:border-b-0 bg-white",
        className,
      )}
      {...props}
    />
...
function TableRow({ className, ...props }) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-colors bg-white",
        className,
      )}
      {...props}
    />
