...
import { getTenders, getMyTenders } from '../../services/appeloffre.service';
...
function MyTendersList() {
  ...
  if (loading) return <div className="p-6">Chargement des appels d'offre...</div>;
  if (!tenders || tenders.length === 0) return <div className="p-6 text-neutral-500">Aucun appel d'offre trouvé</div>;
